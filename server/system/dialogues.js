export const DIALOGUES = {
	...
	CUSTOMER_INTRO: [
		...
		{
			text: "Now it is time to choose the role you would like to take. A well rounded team is important and each role will have different stats and specialize in have different abilities. Introduce yourselves to the customer.",
			speaker: "Team lead",
			side: "right",
	...
	ROLES: [
		{
			text: "Great to see such a well rounded team! Nice to meet you guys. You probably wonder what the project is by now. My company is struggling to keep out viruses and bugs in our network. The project is to build a solution to squash the bugs and keep our network safe. Now I wonder how you will approach this project?",
			speaker: "Customer",
			side: "right",
		},
		{
		...
		{
			text: "This allows us to stay on track and deliver a high-quality product on time and within budget. After each iteration we will meet you to present you the progress. You will be able to discuss any changes you have.",
			speaker: "Team lead",
			side: "right",
		},
		{
	...
	DIGITALWORLD_INTRO: [
		...
		{
			text: "In the upper left corner of your screen, you'll see your current task list, as well as a counter showing how many days you've worked on the project.",
			speaker: "Team lead",
	...
	TASKBOARD_INTRO: [
		...
		{
			text: "Each task also has different rewards we'll receive upon completion. The more difficult the task, the higher the reward. However, we also need to consider the time and energy it will take to complete the task.",
			speaker: "Team lead",
			side: "right",
		},
		{
	...
	SHOP_INTRO: [
		...
		{
			text: "The shop seems to be out of order for now, so it will be closed until further notice.",
			speaker: "Team lead",
			side: "right",
	...
	BEGIN_GAME: [
		...
		{
			text: "A side note, there's also a calendar in the upper left corner of your screen that shows how many days we have left until we have a meeting with the customer.",
			speaker: "Team lead",
	...
	EXPLORATION_END: [
		{
			text: "Greetings! Great work for today. For now, let's head back to the digital world and we'll continue the next day.",
			speaker: "Team lead",
			side: "right",
			action: "TELEPORT_TO_DIGITALWORLD",
		},
	...
	EXPLORATION_INTRO: [
		...
		{
			text: "The different challenge modes that we'll encounter include REST, where we can restore our HP points, BATTLE where we'll battle bugs, glitches and monsters for experience points, and finally TOWER OF TRIALS where we'll have to collaboratively solve quizes and puzzles through communication.",
			speaker: "Team lead",
			side: "right",
		},
		{
			text: "Figuring out what to do and how to do it is part of the challenge. You'll need to work together to figure out the best way to complete the tasks and overcome the challenges. Get ready to start exploring!",
			speaker: "Team lead",
			side: "right",
		},
	],
	...
	BATTLE_INTRO: [
		...
		{
			text: "Let me explain the battling system in more detail. Each of you have three different attack skills, some of which costs energy to use. Attacking normally recovers energy, so you can use your energy skills more often.",
			speaker: "Team lead",
			image: "/sprites/dialogue/battle.png",
			side: "right",
		},
		{
			text: "Use the help button in the bottom right corner to see the skills you have available.",
			speaker: "Team lead",
			side: "right",
		},
		{
			text: "Use your skills to defeat the bugs and complete your tasks. Good luck!",
			speaker: "Team lead",
			side: "right",
		},
	],
